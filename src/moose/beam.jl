...
function get_displacements(x,y,d_vec,frames)
    ...
    w1_theta = WhiskerTracking.convert_to_angular_coordinates(x1,y1,d_vec.*w_length)
    ...
    for i=2:output_frames_t
        ...
        w_theta = WhiskerTracking.convert_to_angular_coordinates(x2,y2,d_vec.*w_length)
